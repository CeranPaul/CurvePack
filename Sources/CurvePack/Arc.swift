...
//        displayCurves.append(offsetArc)
    ...
    /// Checks to see if an Arc (full circle) is fully inside another. Should become a type function in Arc.
    /// - Parameters:
    ...
    /// Build a full Arc that inscribes the two inputs. Should become a type function in Arc.
    /// - Parameters:
    ///   - circleA: One circle
